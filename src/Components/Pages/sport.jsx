          ...
          <div className="grid grid-cols-1 gap-x-7 gap-y-10 sm:grid-cols-2">
            {sportsPosts.map((post) => (
              <div key={post.id} className="w-full">
                ...
                <h3 className="mb-3 max-w-full text-[17px] font-medium leading-[1.15] text-[#111] sm:max-w-[170px]">
                  {post.title}
                </h3>
                ...
                <p className="max-w-full text-[11px] leading-[1.9] text-[#6f6f6f] sm:max-w-[175px]">
                  {post.desc}
                </p>
              </div>
            ))}
